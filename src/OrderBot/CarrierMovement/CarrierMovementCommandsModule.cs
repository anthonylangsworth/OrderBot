    ...
    public class Channel : InteractionModuleBase<SocketInteractionContext>
    {
        ...
        )
        {
            ...
            await Context.Interaction.FollowupAsync(
                text: $"**Success**! Carrier movements will be mentioned in #{channel.Name}. Ensure this bot has 'Send Messages' permission to that channel. This change takes a few minutes to occur.",
                ephemeral: true
            );
        }
