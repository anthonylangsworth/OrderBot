...
namespace OrderBot.Test.ToDo
{
    internal class TestControlGoal
    {
        ...
        public void Instance()
        {
            ...
            Assert.That(ControlGoal.Instance.Description, Is.EqualTo("Be the minor faction with the highest influence. Keep influence between 55% and 70%."));
            Assert.That(ControlGoal.LowerInfluenceThreshold, Is.EqualTo(0.55));
            Assert.That(ControlGoal.UpperInfluenceThreshold, Is.EqualTo(0.70));
        }
